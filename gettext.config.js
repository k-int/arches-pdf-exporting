...
module.exports = {
  input: {
    path: "./arches_pdf_exporting/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_pdf_exporting/locale", // output path of all created files
