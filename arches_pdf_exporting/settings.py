"""
Django settings for arches_pdf_exporting project.
"""
...
DATATYPE_LOCATIONS.append("arches_pdf_exporting.datatypes")
FUNCTION_LOCATIONS.append("arches_pdf_exporting.functions")
ETL_MODULE_LOCATIONS.append("arches_pdf_exporting.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_pdf_exporting.search_components")
...
SECRET_KEY = "django-insecure-h89e8wuq$x^gfp87au%5y&3wj3rsm8yow*!^5z8*9%rb#u@_te"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_pdf_exporting.urls"
ROOT_HOSTCONF = "arches_pdf_exporting.hosts"

DEFAULT_HOST = "arches_pdf_exporting"
...
ELASTICSEARCH_PREFIX = "arches_pdf_exporting"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_pdf_exporting.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_pdf_exporting",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_pdf_exporting.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_pdf_exporting"
